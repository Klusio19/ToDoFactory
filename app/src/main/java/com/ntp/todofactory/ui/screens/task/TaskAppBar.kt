...
fun ExistingAppBarActions(
    ...
    DisplayAlertDialog(
        title = stringResource(R.string.delete_task_dialog_title , selectedTask.title) ,
        message = stringResource(R.string.delete_task_dialog_confirmation , selectedTask.title) ,
